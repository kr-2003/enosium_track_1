      ...
      <footer class="text-gray-600 body-font bg-slate-900">
        <div class="container px-5 py-6 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:mt-0 mt-10">
            ...
            >
              <Link href="/" className="block text-teal-400">
          ...
          <div class="flex-grow flex flex-wrap md:pr-20 -mb-10 md:text-left text-center order-first">
            <div class="lg:w-1/2 md:w-1/2 w-full px-4">
              <h2 class="text-center title-font font-medium tracking-widest text-sm mb-3 text-white">
                CATEGORIES
              </h2>
              <nav class="text-center list-none mb-10">
                <li>
                  <Link
                    href="/"
                    class="text-gray-400 text-center hover:text-white hover:cursor-pointer"
                  >
                    Home
                  </Link>
                </li>
        ...
        <div class="bg-gray-100">
          <div class="container mx-auto py-3 px-5 flex flex-wrap flex-col sm:flex-row">
            <p class="text-gray-500 text-sm text-center sm:text-left">
              © 2023 The Legendary Predictor —
            </p>
            <span class="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
              <Link
                href=""
                class="ml-3 hover:text-black hover:cursor-pointer text-gray-400"
              >
                <svg
                  fill="currentColor"
